   ...
   private static SessionFactory sessionFactory;
    ...
    public static void load(){
        ...
        try {
            ...
            config.setProperty("hibernate.hbm2ddl.auto", "create-drop"); // create-drop crea y elimina la base de datos(solo en inicio) cambiar a update para comenzar a usar 
